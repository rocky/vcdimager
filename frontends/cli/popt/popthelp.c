...
static void
displayArgs (poptContext con, enum poptCallbackReason foo,
...
static void
singleOptionHelp (FILE * f, int maxLeftCol,
		  const struct poptOption *opt,
...
static int
maxArgWidth (const struct poptOption *opt, const char *translation_domain)
{
  int max = 0;
  int this;
  const char *s;
...
static void
singleTableHelp (FILE * f, const struct poptOption *table,
		 int left, const char *translation_domain)
{
  const struct poptOption *opt;
...
static int
showHelpIntro (poptContext con, FILE * f)
{
  int len = 6;
  const char *fn;
...
static int
singleOptionUsage (FILE * f, int cursor,
		   const struct poptOption *opt,
		   const char *translation_domain)
{
  int len = 3;
...
static int
singleTableUsage (FILE * f, int cursor, const struct poptOption *table,
		  const char *translation_domain)
{
  const struct poptOption *opt;
...
static int
showShortOptions (const struct poptOption *opt, FILE * f, char *str)
{
